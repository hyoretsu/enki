import type { TrackMediaDTO } from "@/shared/dtos";
import { HttpException } from "@/shared/errors";
import type { MediaRepository, UsersRepository } from "@/shared/repositories";
...
export class TrackMedia {
	...
	public async execute({ userId, ...rest }: TrackMediaDTO): Promise<void> {
		// The handler strips fields off the variant in place before persisting; keep a loose
		// view so the discriminated-union narrowing doesn't fight the mutations below.
