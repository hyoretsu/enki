      ...
      readonly namespaces: {
        ...
        readonly public: {
          ...
          readonly entries: {
            readonly table: {
              ...
              readonly literaryWork: {
                columns: {
                  ...
                  readonly type: {
                    readonly nativeType: 'LiteraryWorkType';
                    readonly codecId: 'pg/enum@1';
                    readonly nullable: false;
                    readonly typeRef: 'LiteraryWorkType';
                  };
                  readonly tags: {
                    readonly nativeType: 'jsonb';
                    readonly codecId: 'pg/jsonb@1';
              ...
              readonly videoGameRun: {
                ...
                primaryKey: { readonly columns: readonly ['id'] };
                uniques: readonly [{ readonly columns: readonly ['videoGameId', 'name'] }];
                indexes: readonly [];
                foreignKeys: readonly [
                  {
                    readonly source: {
            ...
            readonly type: {
              readonly LiteraryWorkType: {
                readonly kind: 'postgres-enum';
                readonly name: 'LiteraryWorkType';
                readonly nativeType: 'LiteraryWorkType';
                readonly codecId: 'pg/enum@1';
